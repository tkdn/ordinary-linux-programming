// https://github.com/aamine/stdlinux2-source/blob/master/tail.c
#include <stdio.h>
#include <stdlib.h>

#define N_LINES 10
#define MAX_LINE_LENTGH 1024
...
static char ring_buffer[N_LINES][MAX_LINE_LENTGH];
...
tail(FILE *f)
{
  ...
  while (fgets(ring_buffer[curr], MAX_LINE_LENTGH, f))
  {
